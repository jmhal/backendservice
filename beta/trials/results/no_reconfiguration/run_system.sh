...
echo "Running with parameters = $profile_file $qos_values $qos_weights $qos_factor $qos_intervals $computational_input"
python ~/repositorios/elastichpc/beta/trials/infrastructure/backendservice.py ~/openstack/keystonerc_joaoalencar $profile_file $qos_values $qos_weights $qos_factor $qos_intervals $computational_input 
